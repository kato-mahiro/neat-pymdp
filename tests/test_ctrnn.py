import neatmdp
from neatmdp.activations import sigmoid_activation
...
def test_basic():
    ...
    node_evals = {1: neatmdp.ctrnn.CTRNNNodeEval(0.01, sigmoid_activation, sum, -2.75 / 5.0, 1.0, node1_inputs),
                  2: neatmdp.ctrnn.CTRNNNodeEval(0.01, sigmoid_activation, sum, -1.75 / 5.0, 1.0, node2_inputs)}

    net = neatmdp.ctrnn.CTRNN([], [1, 2], node_evals)
