...
from neatmdp.genes import BaseGene
from neatmdp.six_util import iteritems, iterkeys
...
def run(config_file):
    # Load configuration.
    config = neatmdp.Config(CircuitGenome, neatmdp.DefaultReproduction,
    ...
    pe = neatmdp.ParallelEvaluator(4, simulate)
